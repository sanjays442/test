...
angular.module(moduleName, ['ui.router'])
  ...
  // .component('statemapnew', require('./sponsorStateSelect/stateMapNew'))
  ...
  .component('testcenterdone', require('./testCenterDone'))
  ...
  .config(['$stateProvider', 'UIState', function ($stateProvider, UIState) {
    ...
    $stateProvider.state({
      name: UIState.SIGN_UP.SIGNUP_CENTER_DONE,
      url: '/test-center-done',
      template: '<testCenterDone></testCenterDone>'
    });
    $stateProvider.state({
